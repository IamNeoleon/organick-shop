...
import logoImg from '@/assets/icons/main-logo.svg';

interface IFooterProps { }

const Footer: React.FC<IFooterProps> = () => {
   return (
      <footer className='pt-32 max-lg:pt-0'>
         <div className='flex max-w-[1200px] px-[15px] mx-auto max-lg:flex-col max-lg:gap-6 pb-24 max-md:pb-16 max-sm:pb-12'>
            <div className='max-lg:text-center max-lg:p-0 grow-0 shrink basis-1/4 max-lg:order-2 text-right pr-12 pb-9'>
               <div className='font-bold text-3xl text-primary mb-6'>Contact Us</div>
            ...
            <div className='grow-0 shrink basis-1/2 max-lg:order-1 flex flex-col items-center px-10 border-x border-grey max-lg:border-none max-md:px-0'>
               <div className='mb-5 max-md:mb-2'>
                  <img src={logoImg} alt="footer logo" />
               </div>
               <div className='text text-center mb-12 max-lg:mb-6 max-md:mb-4'>
                  Simply dummy text of the printing and typesetting industry.
                  Lorem Ipsum simply dummy text of the printing
               </div>
               <div className='mx-auto flex gap-4 max-[425px]:gap-1'>
                  <div className='w-[60px] h-[60px] rounded-full bg-lgMint flex justify-center items-center cursor-pointer hover:opacity-65 transition-opacity'>
            ...
            <div className='max-lg:p-0 max-lg:text-center grow-0 shrink basis-1/4 text-left pl-12 pb-9 max-lg:order-3'>
               <div className='font-bold text-3xl text-primary mb-6'>Utility Pages</div>
               <div className='flex flex-col gap-6 max-md:gap-4'>
                  <a href='#' className='text hover:underline'>Style Guide</a>
                  <a href='#' className='text hover:underline'>404 Not Found</a>
                  <a href='#' className='text hover:underline'>Password Protected</a>
                  <a href='#' className='text hover:underline'>Licences</a>
                  <a href='#' className='text hover:underline'>Changelog</a>
               </div>
            </div>
         </div>
         <div className='py-4 font-osans text-lg text-primary text-center border-t border-grey'>
